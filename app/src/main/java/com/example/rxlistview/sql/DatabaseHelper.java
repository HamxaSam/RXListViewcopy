package com.example.rxlistview.sql;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "QuizAps.db";
 ...
 // create table sql query
    ...
    public void addUser(User user) {
        ...
        values.put(COLUMN_USER_CONTACT, user.getSname ());

        // Inserting Row
        db.insert(TABLE_USER, null, values);
        db.close();
    }
 public void addQuiz(User user) {
        SQLiteDatabase db = this.getWritableDatabase();

        ContentValues values = new ContentValues();
        values.put(COLUMN_DATE, user.getDate ());
        values.put(COLUMN_TIME, user.getTime ());
        values.put(COLUMN_RESULT, user.getResult ());
     ...
     * @return list
     */
    public ArrayList<User> getAllQuiz() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                user.setResult (cursor.getString(cursor.getColumnIndex(COLUMN_RESULT)));
